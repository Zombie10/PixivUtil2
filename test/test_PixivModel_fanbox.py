...
class TestPixivModel_Fanbox(unittest.TestCase):
    ...
    def testFanboxArtistArticle(self):
        reader = open('./test_data/Fanbox_artist_posts_article.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
    ...
    def testFanboxArtistArticleFileMap(self):
        reader = open('./test_data/creator_with_filemap.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
        artist = FanboxArtist(190026, "", "", None)
        result = artist.parsePosts(p)
    ...
    def testFanboxArtistVideo(self):
        reader = open('./test_data/creator_posts_with_video.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
    ...
    def testFanboxArtistArticleEmbedTwitter(self):
        reader = open('./test_data/creator_embedMap.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
    ...
    def testFanboxPost_url_embed(self):
        reader = open('./test_data/fanbox_urlembed.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
    ...
    def testFanboxArtistPostsNextPage(self):
        ...
        reader = open('./test_data/Fanbox_artist_posts_nextpage.json', 'r', encoding="utf-8")
        p2 = reader.read()
        reader.close()
    ...
    def testFanboxArtistPostsRestricted(self):
        reader = open('./test_data/Fanbox_artist_posts_restricted.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
    ...
    def testFanboxArtistPostsRestrictedNextPage(self):
        reader = open('./test_data/Fanbox_artist_posts_next_page_restricted.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
        artist = FanboxArtist(15521131, "", "", None)
        result = artist.parsePosts(p)
    ...
    def testFanboxOldApi(self):
        reader = open('./test_data/fanbox-posts-old-api.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
    ...
    def testFanboxNewApi(self):
        reader = open('./test_data/fanbox-posts-new-api.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
        artist = FanboxArtist(104409, "", "", None)
        result = artist.parsePosts(p)
    ...
    def testFanboxNewApi2_MultiImages(self):
        reader = open('./test_data/Fanbox_post_with_multi_images.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
        js = json.loads(p)
    ...
    def testFanboxNewApi2_Files(self):
        reader = open('./test_data/Fanbox_post_with_files.json', 'r', encoding="utf-8")
        p = reader.read()
        reader.close()
        js = json.loads(p)
    ...
    def test_links_in_p_tags(self):
        with open('./test_data/test_for_links_in_p_tags.json', 'r', encoding="utf-8") as reader:
            p = reader.read()
        js = json.loads(p)
