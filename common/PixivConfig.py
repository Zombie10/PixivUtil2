...
class PixivConfig():
    ...
    __items = [
        ...
        ConfigItem("Network", "retryBackoff", True),
        ConfigItem("Network", "downloadDelay", 5),
        ConfigItem("Network", "downloadWorkers", 1,
                   restriction=lambda x: int(x) >= 1 and int(x) <= 8),
        ...
        ConfigItem("Debug", "logLevel", "INFO",
                   followup=str.upper,
        ...
        ConfigItem("Debug", "enableRunSummary", True),
        ConfigItem("Debug", "urlListKeepDays", 30, restriction=lambda x: int(x) >= 0),
        ConfigItem("Debug", "logKeepCount", 10, restriction=lambda x: int(x) >= 0),
        ConfigItem("Debug", "enableStartupCleanup", True),
        ...
        ConfigItem("Pixiv", "autoAddStats", False),
        ...
        ConfigItem("FANBOX", "checkUpdatedLimitFanbox", 5),
        ConfigItem("FANBOX", "listPathFanbox", "listfanbox.txt"),
        ConfigItem("FANBOX", "enableCheckpoint", True),
        ConfigItem("FANBOX", "checkpointPathFanbox", ""),
        ...
        ConfigItem("DownloadControl", "checkUpdatedLimit", 5),
